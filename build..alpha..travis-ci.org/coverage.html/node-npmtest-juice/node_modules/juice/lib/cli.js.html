...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-juice/node_modules/juice/lib/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-juice/node_modules/juice/lib/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-juice/node_modules/juice/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
...
module.exports = cli;
&nbsp;
cli.getProgram = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  program.name = pkg.name;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  program.version(pkg.version)</span>
    .usage('[options] input.html output.html');
&nbsp;
<span class="cstat-no" title="statement not covered" >  Object.keys(cli.options).forEach(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >    program.option('--' + key + ' [value]', cli.options[key].def);</span>
  });
&nbsp;
...
&nbsp;
cli.argsToOptions = <span class="fstat-no" title="function not covered" >function(program) {</span>
<span class="cstat-no" title="statement not covered" >  var result = { webResources: {} };</span>
<span class="cstat-no" title="statement not covered" >  Object.keys(cli.options).forEach(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >    var option = cli.options[key];</span>
<span class="cstat-no" title="statement not covered" >    var value = program[option.pMap];</span>
<span class="cstat-no" title="statement not covered" >    if (value !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >      if (option.coercion) {</span>
<span class="cstat-no" title="statement not covered" >        value = option.coercion(value);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (option.pMap.match(/webResources/)) {</span>
<span class="cstat-no" title="statement not covered" >        result.webResources[option.map] = value;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        result[option.map || option.pMap] = value;</span>
      }
    }
  });
&nbsp;
